/* $(function(){
    $('.meulink').on('click', function(){
        let temClasse = $(this).hasClass('ativo');
...
//show e hide mostrar e esconder texto
...
// Toggle faz o mesmo que show e hide mas apenas em um botão .
...
/*
        if (temClasse) {
            $('p').fadeIn(800);
            // Função [complete] quando estiver em uma função vai ser possivel mandar uma mensagem apos a função.
